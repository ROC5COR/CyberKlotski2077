...
const layout = [
  {i: "0", x: 0, y: 0, w: 1, h: 2, img: imgAiBrain},
  {i: "1", x: 1, y: 0, w: 2, h: 2, img: imgPlane},
  {i: "2", x: 3, y: 0, w: 1, h: 2, img: imgAiBrain},
  {i: "3", x: 0, y: 2, w: 1, h: 2, img: imgBattery},
  {i: "4", x: 1, y: 2, w: 2, h: 1, img: imgGear},
  {i: "5", x: 1, y: 3, w: 1, h: 1, img: imgChip},
  {i: "6", x: 2, y: 3, w: 1, h: 1, img: imgChip},
  {i: "7", x: 3, y: 2, w: 1, h: 2, img: imgBattery},
  {i: "8", x: 0, y: 4, w: 1, h: 1, img: imgChip},
  {i: "9", x: 4, y: 4, w: 1, h: 1, img: imgChip},
]
  ...
  render() {
    ...
    return (
      <Grid container direction="column" justify="flex-start" alignItems="center" className={classes.wrapper} id="mainPanel">
        <h1 style={{margin: "15px 0 0 0", textShadow: "1px 1px 1px white"}}>CyberKlotsky 2077</h1>
            ...
            {layout.map((block, i) => {
              ...
              return (
                <div className={this.state.win ? [classes.grid, classTag] : [classes.grid, "moving-grid", classTag]} key={block.i}>
                    <img class="block-img" src={block.img} style={{height: 50, width: 50}}/>
                </div>
          )}
            )}
